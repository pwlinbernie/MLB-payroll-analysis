...
Model 1 shows that Roster Instability exhibits a marginally significant negative effect on team wins (β = -4.50e-08, p = 0.0587).
This indicates that:
Teams experiencing larger year-to-year changes in their active roster tend to win fewer games.
This finding is consistent with Maxcy (2002), who argues that excessive roster turnover disrupts team cohesion and reduces on-field performance.

Moreover:
1. Average Age is strongly and positively associated with wins (p < 0.001), suggesting a potential experience effect.
2. Payroll remains statistically insignificant even after controlling for roster stability, reinforcing the idea that payroll alone does not guarantee performance.

The interaction term between payroll and roster instability is statistically insignificant (p = 0.199).
This suggests that:
Roster instability does not significantly moderate the effect of payroll on team performance.

Although unstable rosters tend to perform worse, increasing payroll does not systematically strengthen or weaken this relationship.
This reinforces the earlier finding that payroll alone is not a strong predictor of team success.

The results highlight two key insights:
1. Roster stability is a meaningful predictor of team performance.Teams that maintain continuity in their core roster tend to outperform teams with high turnover.
2. Payroll remains a weak predictor of success in MLB, even after accounting for roster stability.
This underscores the idea that organizational strategy, player development, and roster construction matter more than financial spending alone.
